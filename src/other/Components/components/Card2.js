...
const card2 = ({src, br=4,style,border=[],coulumn1,coulumn2,coulumn3,coulumn4,coulumn5,coulumn6,h,c1,c2,c3,c4,c5,c6,bgcolor,...p}) => {

  return (
    <Span style={style} h={h?h:300} w={'90%'} as={'center'} br={br} border={border.length?border:[1]} {...p} >

     {src && <Span h={'45%'} >
        <Img f={1} style={{borderTopRightRadius:br, borderTopLeftRadius:br}}  src={src} />
      </Span>}

      <Span h={src?'55%':'100%'} bgcolor={bgcolor} br={br}>
