...
import { A_icon, Badge, Button, Card, FlatList, Icon, M_icon, P, Press, Py, Row, Span } from '../../../../other/Components/Html'
              ...
              <Card
                bgcolor='#fff' color='black' dr='rtl' border={[1, '#eeee']} headerRow={
                  <Span fd='row-reverse' w='100%' >
                    ...
                    <Row mh={15} >
                      <A_icon onClick={() => { p.navigation.navigate('EditComment', { id: p.route.params.id, commentid: item._id }) }} name='edit' size={18} color='#777' style={{ marginHorizontal: 5 }} />
                  ...
                  <Span fd='row-reverse' >
                    ...
                    <Span bgcolor='silver' p={7} pv={4} mh={2} br={5} jc='center' ai='center' ><P fs={12} mt={2} >↩</P></Span>
                  </Span>
                } />
            </Span>
          )}
